...
class CustomRF:
    ...
    def Fast_TrainAndTest(self, n_trees, m):
    ...
    def FastMonthly_TrainAndTest(self, n_trees, m, Ymonths):
        ...
        for i in range(len(mon)):
            ...
            print ('Test rmse: %.4f' % rmselist[i])
            print ('Test Rrmse: %.4f' % RRMSElist[i])
            print ('OOB error: %.4f' % oob_scorelist[i])
    ...
    def VariableImportance_general(self, n_trees, m, NbestFeatures, variables):
        '''
    ...
    def TrainAndTest(self, n_trees, classification=False):
        '''
